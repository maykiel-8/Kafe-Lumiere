...
<div class="auth-right">
    <div class="auth-card">
        ...
        @if($errors->any())
            <div class="error-box"><i class="bi bi-exclamation-circle"></i> {{ $errors->first() }}</div>
        @endif
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div class="grid2" style="margin-bottom:1rem;">
                <div>
                    ...
                    <input class="inp @error('first_name') err @enderror" name="first_name" value="{{ old('first_name') }}" placeholder="First" required>
                    @error('first_name')<div class="err-msg">{{ $message }}</div>@enderror
                </div>
                <div>
                    <label class="lbl">Last Name *</label>
                    <input class="inp @error('last_name') err @enderror" name="last_name" value="{{ old('last_name') }}" placeholder="Last" required>
                    @error('last_name')<div class="err-msg">{{ $message }}</div>@enderror
                </div>
            </div>
 
            <div style="margin-bottom:1rem;">
                <label class="lbl">Email Address *</label>
                <input class="inp @error('email') err @enderror" name="email" type="email" value="{{ old('email') }}" placeholder="your@email.com" required>
            ...
            <div style="margin-bottom:1rem;">
                ...
                <input class="inp @error('password') err @enderror" name="password" type="password" placeholder="Create a password" oninput="checkStrength(this.value)" required>
