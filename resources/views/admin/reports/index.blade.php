...
@section('page-title','Reports & Charts')
 
@section('content')
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="stat-card">
            <div class="stat-label">{{ $year }} Total Revenue</div>
            <div class="stat-value">₱{{ number_format($totalRevenue,2) }}</div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="stat-card">
            <div class="stat-label">{{ $year }} Total Orders</div>
...
<div class="kafe-card mb-3">
    <div class="kafe-card-body" style="padding:1rem 1.5rem;">
        <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
            ...
            <input type="date" id="rptFrom" class="form-control-kafe" style="width:145px;" value="{{ now()->startOfYear()->toDateString() }}">
            <span style="font-size:.8rem;color:#888;">to</span>
            <input type="date" id="rptTo" class="form-control-kafe" style="width:145px;" value="{{ now()->toDateString() }}">
            <button class="btn-kafe" onclick="loadCharts()"><i class="bi bi-bar-chart"></i> Apply</button>
            <a href="{{ route('admin.reports.export') }}" class="btn-kafe-outline" id="exportLink">
