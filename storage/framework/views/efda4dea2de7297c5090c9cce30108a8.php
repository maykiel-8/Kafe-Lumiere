...
<div class="wrap">
  ...
  <div class="body">
    <p style="font-size:14px;margin-bottom:12px;">Hi <strong><?php echo e($transaction->customer_name); ?></strong>,</p>
    <p style="font-size:13px;color:#555;margin-bottom:10px;">
      Your order <strong><?php echo e($transaction->order_number); ?></strong> status has been updated.
    </p>

    <div>
      <span style="font-size:12px;color:#888;">Previous:</span>
      <span class="badge badge-<?php echo e($oldStatus); ?>"><?php echo e(ucfirst($oldStatus)); ?></span>
      <span style="color:#888;margin:0 6px;">→</span>
      <span class="badge badge-<?php echo e($transaction->status); ?>"><?php echo e(ucfirst($transaction->status)); ?></span>
    </div>

    <div class="info-box">
      <div class="info-row"><span>Order Number</span><strong><?php echo e($transaction->order_number); ?></strong></div>
      <div class="info-row"><span>Total</span><strong>₱<?php echo e(number_format($transaction->total,2)); ?></strong></div>
      <div class="info-row"><span>Payment</span><strong style="text-transform:uppercase;"><?php echo e($transaction->payment_method); ?></strong></div>
      <div class="info-row"><span>Updated</span><strong><?php echo e($transaction->updated_at->timezone('Asia/Manila')->format('M d, Y h:i A')); ?></strong></div>
    </div>
...
</html><?php /**PATH C:\Users\admin\kafe-lumiere\resources\views/emails/status-updated.blade.php ENDPATH**/ ?>