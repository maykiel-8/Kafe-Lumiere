        ...
        <?php if($errors->any()): ?>
            ...
            <?php else: ?>
                <div class="alert-error">
                    ...
                    <span><?php echo e($emailError); ?></span>
                </div>
            <?php endif; ?>
        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"
        ...
        <div style="text-align:center;margin-top:1.2rem;font-size:.78rem;color:#888;">
            Don't have an account? <a href="<?php echo e(route('register')); ?>" class="link">Register here</a>
        </div>
...
<?php /**PATH C:\Users\admin\kafe-lumiere\resources\views/auth/login.blade.php ENDPATH**/ ?>